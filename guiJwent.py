    ...
    def run(self):
        ...
        while (p1_games_won < 2) and (p2_games_won < 2) and (games_complete < 3):
            ...
            if (p1_pass == True) and (p2_pass == True):
                ...
                input('Enter anything for Player %s to take turn.  ' % player_turn)
...
class mainWindow(QtGui.QMainWindow, board.Ui_MainWindow):   # main thread
    ...
    def drawCurrentP1Hand(self, p1_hand):
        if self.player_turn == 1:
            ...
            if handSize > 15:
                self.hand_16.setPixmap(QtGui.QPixmap('images/' + p1_hand[15] + '.jpg'))
                self.hand_16.show()
            else:
                self.hand_16.hide()

            if handSize > 16:
                self.hand_17.setPixmap(QtGui.QPixmap('images/' + p1_hand[16] + '.jpg'))
                self.hand_17.show()
            else:
                self.hand_17.hide()

            if handSize > 17:
                self.hand_18.setPixmap(QtGui.QPixmap('images/' + p1_hand[17] + '.jpg'))
                self.hand_18.show()
            else:
                self.hand_18.hide()

            if handSize > 18:
                self.hand_19.setPixmap(QtGui.QPixmap('images/' + p1_hand[18] + '.jpg'))
                self.hand_19.show()
            else:
                self.hand_19.hide()

            if handSize > 19:
                self.hand_20.setPixmap(QtGui.QPixmap('images/' + p1_hand[19] + '.jpg'))
                self.hand_20.show()
            else:
                self.hand_20.hide()
    ...
    def drawCurrentP2Hand(self, p2_hand):
        if self.player_turn == 2:
            ...
            if handSize > 15:
                self.hand_16.setPixmap(QtGui.QPixmap('images/' + p2_hand[15] + '.jpg'))
                self.hand_16.show()
            else:
                self.hand_16.hide()

            if handSize > 16:
                self.hand_17.setPixmap(QtGui.QPixmap('images/' + p2_hand[16] + '.jpg'))
                self.hand_17.show()
            else:
                self.hand_17.hide()

            if handSize > 17:
                self.hand_18.setPixmap(QtGui.QPixmap('images/' + p2_hand[17] + '.jpg'))
                self.hand_18.show()
            else:
                self.hand_18.hide()

            if handSize > 18:
                self.hand_19.setPixmap(QtGui.QPixmap('images/' + p2_hand[18] + '.jpg'))
                self.hand_19.show()
            else:
                self.hand_19.hide()

            if handSize > 19:
                self.hand_20.setPixmap(QtGui.QPixmap('images/' + p2_hand[19] + '.jpg'))
                self.hand_20.show()
            else:
                self.hand_20.hide()
    ...
    def drawCurrentP1MeleeLine(self, p1_melee_line):
        ...
        if p1_melee_line_size > 15:
            self.p1_melee_row16.setPixmap(QtGui.QPixmap('images/' + p1_melee_line[15] + '.jpg'))
            self.p1_melee_row16.show()
        else:
            self.p1_melee_row16.hide()

        if p1_melee_line_size > 16:
            self.p1_melee_row17.setPixmap(QtGui.QPixmap('images/' + p1_melee_line[16] + '.jpg'))
            self.p1_melee_row17.show()
        else:
            self.p1_melee_row17.hide()

        if p1_melee_line_size > 17:
            self.p1_melee_row18.setPixmap(QtGui.QPixmap('images/' + p1_melee_line[17] + '.jpg'))
            self.p1_melee_row18.show()
        else:
            self.p1_melee_row18.hide()

        if p1_melee_line_size > 18:
            self.p1_melee_row19.setPixmap(QtGui.QPixmap('images/' + p1_melee_line[18] + '.jpg'))
            self.p1_melee_row19.show()
        else:
            self.p1_melee_row19.hide()

        if p1_melee_line_size > 19:
            self.p1_melee_row20.setPixmap(QtGui.QPixmap('images/' + p1_melee_line[19] + '.jpg'))
    ...
    def drawCurrentP1RangedLine(self, p1_ranged_line):
        ...
        if p1_ranged_line_size > 15:
            self.p1_ranged_row16.setPixmap(QtGui.QPixmap('images/' + p1_ranged_line[15] + '.jpg'))
            self.p1_ranged_row16.show()
        else:
            self.p1_ranged_row16.hide()

        if p1_ranged_line_size > 16:
            self.p1_ranged_row17.setPixmap(QtGui.QPixmap('images/' + p1_ranged_line[16] + '.jpg'))
            self.p1_ranged_row17.show()
        else:
            self.p1_ranged_row17.hide()

        if p1_ranged_line_size > 17:
            self.p1_ranged_row18.setPixmap(QtGui.QPixmap('images/' + p1_ranged_line[17] + '.jpg'))
            self.p1_ranged_row18.show()
        else:
            self.p1_ranged_row18.hide()

        if p1_ranged_line_size > 18:
            self.p1_ranged_row19.setPixmap(QtGui.QPixmap('images/' + p1_ranged_line[18] + '.jpg'))
            self.p1_ranged_row19.show()
        else:
            self.p1_ranged_row19.hide()

        if p1_ranged_line_size > 19:
            self.p1_ranged_row20.setPixmap(QtGui.QPixmap('images/' + p1_ranged_line[19] + '.jpg'))
    ...
    def drawCurrentP1SiegeLine(self, p1_siege_line):
        ...
        if p1_siege_line_size > 15:
            self.p1_siege_row16.setPixmap(QtGui.QPixmap('images/' + p1_siege_line[15] + '.jpg'))
            self.p1_siege_row16.show()
        else:
            self.p1_siege_row16.hide()

        if p1_siege_line_size > 16:
            self.p1_siege_row17.setPixmap(QtGui.QPixmap('images/' + p1_siege_line[16] + '.jpg'))
            self.p1_siege_row17.show()
        else:
            self.p1_siege_row17.hide()

        if p1_siege_line_size > 17:
            self.p1_siege_row18.setPixmap(QtGui.QPixmap('images/' + p1_siege_line[17] + '.jpg'))
            self.p1_siege_row18.show()
        else:
            self.p1_siege_row18.hide()

        if p1_siege_line_size > 18:
            self.p1_siege_row19.setPixmap(QtGui.QPixmap('images/' + p1_siege_line[18] + '.jpg'))
            self.p1_siege_row19.show()
        else:
            self.p1_siege_row19.hide()

        if p1_siege_line_size > 19:
            self.p1_siege_row20.setPixmap(QtGui.QPixmap('images/' + p1_siege_line[19] + '.jpg'))
    ...
    def drawCurrentP2MeleeLine(self, p2_melee_line):
        ...
        if p2_melee_line_size > 15:
            self.p2_melee_row16.setPixmap(QtGui.QPixmap('images/' + p2_melee_line[15] + '.jpg'))
            self.p2_melee_row16.show()
        else:
            self.p2_melee_row16.hide()

        if p2_melee_line_size > 16:
            self.p2_melee_row17.setPixmap(QtGui.QPixmap('images/' + p2_melee_line[16] + '.jpg'))
            self.p2_melee_row17.show()
        else:
            self.p2_melee_row17.hide()

        if p2_melee_line_size > 17:
            self.p2_melee_row18.setPixmap(QtGui.QPixmap('images/' + p2_melee_line[17] + '.jpg'))
            self.p2_melee_row18.show()
        else:
            self.p2_melee_row18.hide()

        if p2_melee_line_size > 18:
            self.p2_melee_row19.setPixmap(QtGui.QPixmap('images/' + p2_melee_line[18] + '.jpg'))
            self.p2_melee_row19.show()
        else:
            self.p2_melee_row19.hide()

        if p2_melee_line_size > 19:
            self.p2_melee_row20.setPixmap(QtGui.QPixmap('images/' + p2_melee_line[19] + '.jpg'))
    ...
    def drawCurrentP2RangedLine(self, p2_ranged_line):
        ...
        if p2_ranged_line_size > 15:
            self.p2_ranged_row16.setPixmap(QtGui.QPixmap('images/' + p2_ranged_line[15] + '.jpg'))
            self.p2_ranged_row16.show()
        else:
            self.p2_ranged_row16.hide()

        if p2_ranged_line_size > 16:
            self.p2_ranged_row17.setPixmap(QtGui.QPixmap('images/' + p2_ranged_line[16] + '.jpg'))
            self.p2_ranged_row17.show()
        else:
            self.p2_ranged_row17.hide()

        if p2_ranged_line_size > 17:
            self.p2_ranged_row18.setPixmap(QtGui.QPixmap('images/' + p2_ranged_line[17] + '.jpg'))
            self.p2_ranged_row18.show()
        else:
            self.p2_ranged_row18.hide()

        if p2_ranged_line_size > 18:
            self.p2_ranged_row19.setPixmap(QtGui.QPixmap('images/' + p2_ranged_line[18] + '.jpg'))
            self.p2_ranged_row19.show()
        else:
            self.p2_ranged_row19.hide()

        if p2_ranged_line_size > 19:
            self.p2_ranged_row20.setPixmap(QtGui.QPixmap('images/' + p2_ranged_line[19] + '.jpg'))
    ...
    def drawCurrentP2SiegeLine(self, p2_siege_line):
        ...
        if p2_siege_line_size > 15:
            self.p2_siege_row16.setPixmap(QtGui.QPixmap('images/' + p2_siege_line[15] + '.jpg'))
            self.p2_siege_row16.show()
        else:
            self.p2_siege_row16.hide()

        if p2_siege_line_size > 16:
            self.p2_siege_row17.setPixmap(QtGui.QPixmap('images/' + p2_siege_line[16] + '.jpg'))
            self.p2_siege_row17.show()
        else:
            self.p2_siege_row17.hide()

        if p2_siege_line_size > 17:
            self.p2_siege_row18.setPixmap(QtGui.QPixmap('images/' + p2_siege_line[17] + '.jpg'))
            self.p2_siege_row18.show()
        else:
            self.p2_siege_row18.hide()

        if p2_siege_line_size > 18:
            self.p2_siege_row19.setPixmap(QtGui.QPixmap('images/' + p2_siege_line[18] + '.jpg'))
            self.p2_siege_row19.show()
        else:
            self.p2_siege_row19.hide()

        if p2_siege_line_size > 19:
            self.p2_siege_row20.setPixmap(QtGui.QPixmap('images/' + p2_siege_line[19] + '.jpg'))
